...
{{- define "eric-adp-gui-aggregator-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-adp-gui-aggregator-service.mergeAnnotations" -}}
  {{- include "eric-adp-gui-aggregator-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-adp-gui-aggregator-service.mergeLabels" -}}
  {{- include "eric-adp-gui-aggregator-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
