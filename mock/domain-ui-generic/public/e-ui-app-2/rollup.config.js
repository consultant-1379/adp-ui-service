...
const userRollupConfig = {
  ...
  importMap: {
    imports: {
      ...
      '@eui/layout': './node_modules/@eui/layout/index.js',
    },
  },
};
...
euisdkRollupConfig.plugins.splice(
  ...
  copy({
    targets: [
      ...
      { src: 'components/!(*.html|*.css|*.js)', dest: `${outDirectory}/components/` },
...
const jsfiles = globSync(['apps/**/*.js', 'components/**/*.js'], { posix: true });
const srcEntries = {};
